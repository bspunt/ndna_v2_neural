...
#######################################################
        ...
        sql_connection_full("REPLACE INTO neural_ndnanexusdevice(Hostname,Local_IPs,Local_SVI_IPs,Local_mgmt_IPs,NXOS_Platform,NXOS_Image,NXOSVersion,Flash,SerialNo) VALUES(%s, %s, %s, %s, %s, %s, %s, %s, %s)", (hostname, Local_IPs_var, Local_SVI_IPs_var, Local_mgmt_IPs_var, nxos_platform, nxosimage_name, nxos, flash, serial_no))
