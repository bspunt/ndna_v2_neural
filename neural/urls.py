...
urlpatterns = [
    ...
    path('ndna_ios_devices/', views.ndna_ios_devices, name ='ndna_ios_devices'),
    path('ndna_nxos_devices/', views.ndna_nxos_devices, name ='ndna_nxos_devices'),
    path('ndna_automation/', views.ndna_automation, name ='ndna_automation'),
    ###################
    ...
    path('self_service_ios_inventory', views.self_service_ios_inventory, name ='self_service_ios_inventory'),
    path('self_service_nxos_inventory', views.self_service_nxos_inventory, name ='self_service_nxos_inventory'),
    ###################
    ###################
    ...
    ###################
    ###################
    path('ndna_diagram_xmls', views.ndna_diagram_xmls, name ='ndna_diagram_xmls'),
    ###################
    ###################
    path('download_specific_files', views.download_specific_files, name ='download_specific_files'),
    ###################
    path('NDNA_Discovery', views.NDNA_Discovery, name ='NDNA_Discovery'),
    ###################
