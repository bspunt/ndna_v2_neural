...
###################################################
class NeuralNotebookParams(models.Model):
    notebook_name = models.CharField(max_length=50)
    notebook_command_list = models.TextField(null=True, blank=True)
    notebook_default_variables = models.TextField(null=True, blank=True)
    notebook_nodes_lists = models.TextField(null=True, blank=True)
    def __str__(self):
