...
from .models import (Device, Log, JobResult, Inventorie, Configtemplate,  
T3, root, svcacct, 
VRF, Jinjatemplate, SCP, GoldenConfig, GoldenConfigDiffs, NeuralNotebookParams)
...
admin.site.register(NeuralNotebookParams)